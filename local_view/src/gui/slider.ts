...
export class Slider extends GUIComponent {
    ...
    public constructor(
        ...
        Application.getInstance().registerToTextPlane(this.minText);
        ...
        Application.getInstance().registerToTextPlane(this.maxText);
        ...
        Application.getInstance().registerToTextPlane(this.valText);
